...
def process_image(
    ...
    cutout_path = output_dir / f"{name_pattern.format(stem=stem)}.png"
...
def main() -> None:
    ...
    parser.add_argument(
        "--name-pattern",
        type=str,
        default="{stem}_cutout",
        help="Output filename pattern, {stem} = input stem (default: {stem}_cutout)",
    )
